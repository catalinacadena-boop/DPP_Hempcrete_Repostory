...
if __name__ == '__main__':
    # Use full path to the IFC file
    fname = r"C:\Users\Catalina\OneDrive - Pontificia Universidad Javeriana\Desktop\THESIS\Methodology\IFC to LBD\Project1.ifc"
    # Output file in the same directory
    ofile = os.path.join(os.path.dirname(fname), "Project1.ttl")
    convertIFCSPFtoTTL(fname, ofile)

#the converted file is saved in the same file as the ifc.                                